...
//Database Connection
const db = "mongodb://localhost:27017/amsFugus?authSource=admin"
mongosse.connect(db, {useNewUrlParser: true ,
  user:'superuser',
  pass:'12345678',
...
app.get('/api/course/export/:id',course_Control.course_export)
app.get('/api/course/verification/:id',course_Control.course_verification)
app.post('/api/course/close/:id',course_Control.close)
app.post('/api/course/enrollhandler/:c_id/:allow',course_Control.enrollhandler)
...
app.post('/api/student/attendnotifier/',student_Control.attend_notifier)
//Login controls
